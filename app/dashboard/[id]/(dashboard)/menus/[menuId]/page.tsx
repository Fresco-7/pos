...
const MenuPage = async ({ params }: { params: { id: string, menuId: string } }) => {
        ...
        return (
            <main className="flex mt-48 items-center justify-center text-center px-4 sm:px-6 lg:px-8">
                <div>
                    ...
                    <div className="mt-8">
                        <Link href={`/dashboard/${params.id}/menus`}>
    ...
    return (
        <>
            <div className="space-y-6 p-10 pt-8 pb-16 block">
                <ChartComponent dataDay={dataDay} dataMonth={dataMonth} dataYear={dataYear} name={menu.name}/>
            </div>
